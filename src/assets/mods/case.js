...
layui.define(['laypage', 'fly'], function (exports) {
  ...
  const active = {
    ...
    push: function (div) {
      layer.open({
        ...
        success: function (layero, index) {
          const image = layero.find('.fly-case-image')
    ...
    praise: function (othis) {
      const li = othis.parents('li')
      const PRIMARY = 'layui-btn-primary'
      const unpraise = !othis.hasClass(PRIMARY)
      const numElem = li.find('.fly-case-nums')
