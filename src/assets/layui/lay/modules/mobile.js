...
layui.define(function (e) {
  ...
  const i = 'querySelectorAll'
  const n = 'getElementsByClassName'
  const a = function (e) {
    return t[i](e)
  }
  const s = { type: 0, shade: !0, shadeClose: !0, fixed: !0, anim: 'scale' }
  const l = {
    extend: function (e) {
  ...
  ;(d.prototype.view = function () {
    ...
    const l = (function () {
      const e = typeof i.title === 'object'
      return i.title
        ? '<h3 style="' + (e ? i.title[1] : '') + '">' + (e ? i.title[0] : i.title) + '</h3>'
        : ''
    })()
    const d = (function () {
      typeof i.btn === 'string' && (i.btn = [i.btn])
      let e
      const t = (i.btn || []).length
      return t !== 0 && i.btn
        ? ((e = '<span yes type="1">' + i.btn[0] + '</span>'),
          t === 2 && (e = '<span no type="0">' + i.btn[1] + '</span>' + e),
    ...
    if (
      ...
      i.type === 2 &&
        (i.content =
          '<i></i><i class="layui-m-layerload"></i><i></i><p>' + (i.content || '') + '</p>'),
      i.skin && (i.anim = 'up'),
      i.skin === 'msg' && (i.shade = !1),
      (s.innerHTML =
        (i.shade
          ? '<div ' +
            (typeof i.shade === 'string' ? 'style="' + i.shade + '"' : '') +
      ...
      const y = t[n](r[0] + i.type)
      const u = y.length
      u >= 1 && c.close(y[0].getAttribute('index'))
    }
    document.body.appendChild(s)
    const m = (e.elem = a('#' + e.id)[0])
    ...
    (d.prototype.action = function (e, t) {
      ...
      const a = function () {
        ...
        t == 0 ? (e.no && e.no(), c.close(i.index)) : e.yes ? e.yes(i.index) : c.close(i.index)
      }
      if (e.btn) {
        for (let s = t[n]('layui-m-layerbtn')[0].children, o = s.length, r = 0; r < o; r++) {
          l.touch(s[r], a)
        }
      }
      if (e.shade && e.shadeClose) {
        const d = t[n]('layui-m-layershade')[0]
        l.touch(d, function () {
  ...
  var c = {
    ...
    close: function (e) {
      ...
      i &&
        ...
        delete l.timer[e],
        typeof l.end[e] === 'function' && l.end[e](),
        delete l.end[e])
    },
    closeAll: function () {
      for (let e = t[n](r[0]), i = 0, a = e.length; i < a; i++) {
...
layui.define(function (t) {
  const e = (function () {
    function t(t) {
      return t == null ? String(t) : J[W.call(t)] || 'object'
    }
    function e(e) {
      return t(e) == 'function'
    }
    ...
    function a(t) {
      ...
      return (
        r != 'function' &&
        !n(t) &&
        (r == 'array' || e === 0 || (typeof e === 'number' && e > 0 && e - 1 in t))
      )
    }
    function s(t) {
    ...
    function f(t, e) {
      return typeof e !== 'number' || k[c(t)] ? e : e + 'px'
    }
    function h(t) {
      let e, n
      return (
    ...
    function v(t, e) {
      return e == null ? T(t) : T(t).filter(e)
    }
    function g(t, n, r, i) {
    ...
    function b(t) {
      try {
        return t
          ? t == 'true' ||
              (t != 'false' &&
                (t == 'null' ? null : +t + '' == t ? +t : /^[\[\{]/.test(t) ? T.parseJSON(t) : t))
          : t
      } catch (e) {
        return t
      }
    ...
    function w(t, e) {
      e(t)
      for (let n = 0, r = t.childNodes.length; n < r; n++) w(t.childNodes[n], e)
    }
    let E
    let j
    let T
    ...
    const M = /^\s*<(\w+|!)[^>]*>/
    const R = /^<(\w+)\s*\/?>(?:<\/\1>|)$/
    const z = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi
    const Z = /^(?:body|html)$/i
    const q = /([A-Z])/g
    const H = ['val', 'css', 'html', 'text', 'data', 'width', 'height', 'offset']
    const I = ['after', 'prepend', 'before', 'append']
    const V = L.createElement('table')
    const _ = L.createElement('tr')
    const B = {
    ...
    return (
      ...
      (T.extend = function (t) {
        let e
        const n = D.call(arguments, 1)
        return (
          typeof t === 'boolean' && ((e = t), (t = n.shift())),
      ...
      (T.map = function (t, e) {
        ...
        let i
        const o = []
        if (a(t)) for (r = 0; r < t.length; r++) (n = e(t[r], r)), n != null && o.push(n)
        else for (i in t) (n = e(t[i], i)), n != null && o.push(n)
        return u(o)
      }),
      (T.each = function (t, e) {
        let n, r
      ...
      (T.fn = {
        ...
        not: function (t) {
          ...
          if (e(t) && t.call !== E) {
            ...
            const r = typeof t === 'string' ? this.filter(t) : a(t) && e(t.item) ? D.call(t) : T(t)
        ...
        wrap: function (t) {
          ...
          if (this[0] && !n) {
            var r = T(t).get(0)
            var i = r.parentNode || this.length > 1
          }
        ...
        text: function (t) {
          return 0 in arguments
            ? this.each(function (e) {
                const n = g(this, t, e, this.textContent)
        ...
        attr: function (t, e) {
          let n
          return typeof t !== 'string' || 1 in arguments
            ...
            : 0 in this && this[0].nodeType == 1 && (n = this[0].getAttribute(t)) != null
            ? n
            : E
        },
        ...
        data: function (t, e) {
          const n = 'data-' + t.replace(q, '-$1').toLowerCase()
          const r = 1 in arguments ? this.attr(n, e) : this.attr(n)
          return r !== null ? b(r) : E
        },
        val: function (t) {
          return 0 in arguments
        ...
        offset: function (t) {
          if (t) {
            return this.each(function (e) {
              const n = T(this)
              const r = g(this, t, e, n.offset())
              const i = n.offsetParent().offset()
              const o = { top: r.top - i.top, left: r.left - i.left }
              n.css('position') == 'static' && (o.position = 'relative'), n.css(o)
            })
          }
        ...
        position: function () {
          if (this.length) {
            const t = this[0]
            const e = this.offsetParent()
            const n = this.offset()
            const r = Z.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset()
            return (
        ...
        offsetParent: function () {
          return this.map(function () {
            for (
              ...
              t && !Z.test(t.nodeName) && T(t).css('position') == 'static';
      ...
      I.forEach(function (e, n) {
        ...
        ;(T.fn[e] = function () {
          let e
          let i
          const o = T.map(arguments, function (n) {
            let r = []
            return (
              (e = t(n)),
              e == 'array'
          ...
          return o.length < 1
            ...
            : this.each(function (t, e) {
                ;(i = r ? e : e.parentNode),
                  (e = n == 0 ? e.nextSibling : n == 1 ? e.firstChild : n == 2 ? e : null)
                const s = T.contains(L.documentElement, i)
                    ...
                    s &&
                      w(t, function (t) {
                        if (
                          !(
                            t.nodeName == null ||
                            t.nodeName.toUpperCase() !== 'SCRIPT' ||
                            (t.type && t.type !== 'text/javascript') ||
                            t.src
                          )
                        ) {
                          const e = t.ownerDocument ? t.ownerDocument.defaultView : window
  ...
  !(function (t) {
    ...
    function s(n, i, s, u, l, h, p) {
      ...
      i.split(/\s/).forEach(function (e) {
        if (e == 'ready') return t(document).ready(s)
        const i = r(e)
        ;(i.fn = s),
          (i.sel = l),
          i.e in b &&
        ...
        ;(i.proxy = function (t) {
          if (((t = c(t)), !t.isImmediatePropagationStopped())) {
            t.data = u
            const e = d.apply(n, t._args == f ? [t] : [t].concat(t._args))
      ...
      return (
        (!n && e.isDefaultPrevented) ||
          ...
          (n.defaultPrevented !== f
            ...
            : 'returnValue' in n
            ? n.returnValue === !1
            : n.getPreventDefault && n.getPreventDefault()) && (e.isDefaultPrevented = w)),
        e
      )
    }
    function l(t) {
      let e
      const n = { originalEvent: t }
    ...
    const d = t.isFunction
    const m = function (t) {
      return typeof t === 'string'
    }
    var v = {}
    const g = {}
    var y = 'onfocusin' in window
    var x = { focus: 'focusin', blur: 'focusout' }
    ...
    ;(g.click = g.mousedown = g.mouseup = g.mousemove = 'MouseEvents'),
      ...
      (t.proxy = function (n, r) {
        const i = 2 in arguments && p.call(arguments, 2)
        if (d(n)) {
          const o = function () {
    ...
    var j = /^([A-Z]|returnValue$|layer[XY]$|webkitMovement[XY]$)/
    var T = {
    ...
    ;(t.fn.delegate = function (t, e, n) {
            ...
            h.each(function (f, h) {
              o &&
                ...
                n &&
                  (c = function (e) {
                    let r
                    const o = t(e.target).closest(n, h).get(0)
                    if (o && o !== h) {
                      return (
      ...
      (t.fn.trigger = function (e, n) {
        return (
          ...
          (e._args = n),
          this.each(function () {
            e.type in x && typeof this[e.type] === 'function'
              ? this[e.type]()
      ...
      (t.Event = function (t, e) {
        m(t) || ((e = t), (t = e.type))
        const n = document.createEvent(g[t] || 'Events')
        let r = !0
        if (e) for (const i in e) i == 'bubbles' ? (r = !!e[i]) : (n[i] = e[i])
    ...
    (function (t) {
      ...
      function r(e) {
        e.global && t.active++ === 0 && n(e, null, 'ajaxStart')
      }
      function i(e) {
      ...
      function f(t) {
        return (
          t && (t = t.split(';', 2)[0]),
          (t && (t == T ? 'html' : t == j ? 'json' : w.test(t) ? 'script' : E.test(t) && 'xml')) ||
            'text'
        )
      }
      function h(t, e) {
      ...
      function p(e) {
        e.processData &&
          e.data &&
          t.type(e.data) != 'string' &&
          (e.data = t.param(e.data, e.traditional)),
          !e.data ||
            (e.type && e.type.toUpperCase() != 'GET' && e.dataType != 'jsonp') ||
      ...
      function m(e, n, r, i) {
        let o
        const a = t.isArray(n)
        const s = t.isPlainObject(n)
        t.each(n, function (n, u) {
          ;(o = t.type(u)),
            i && (n = r ? i : i + '[' + (s || o == 'object' || o == 'array' ? n : '') + ']'),
            !i && a
      ...
      const b = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi
      var w = /^(?:text|application)\/javascript/i
      var E = /^(?:text|application)\/xml/i
      var j = 'application/json'
      var T = 'text/html'
      const S = /^\s*$/
      const C = x.createElement('a')
      ;(C.href = window.location.href),
        ...
        (t.ajaxJSONP = function (e, n) {
          ...
          let r
          let i
          const u = e.jsonpCallback
          const c = (t.isFunction(u) ? u() : u) || 'Zepto' + y++
          const l = x.createElement('script')
          let f = window[c]
          const h = function (e) {
          ...
          return (
            ...
            t(l).on('load error', function (o, u) {
              clearTimeout(i),
                t(l).off().remove(),
                o.type != 'error' && r ? a(r[0], p, e, n) : s(null, u || 'error', p, e, n),
                (window[c] = f),
        ...
        (t.ajax = function (e) {
          ...
          if (
            (y && (m = 'jsonp'),
            (u.cache !== !1 && ((e && e.cache === !0) || (m != 'script' && m != 'jsonp'))) ||
              (u.url = h(u.url, '_=' + Date.now())),
            m == 'jsonp')
          ) {
            return (
              y ||
                (u.url = h(u.url, u.jsonp ? u.jsonp + '=?' : u.jsonp === !1 ? '' : 'callback=?')),
              t.ajaxJSONP(u, d)
            )
          }
          let b
          ...
          const T = /^([\w-]+:)\/\//.test(u.url) ? RegExp.$1 : window.location.protocol
          const N = u.xhr()
          const O = N.setRequestHeader
          if (
            (d && d.promise(N),
            ...
            (u.contentType || (u.contentType !== !1 && u.data && u.type.toUpperCase() != 'GET')) &&
              j('Content-Type', u.contentType || 'application/x-www-form-urlencoded'),
            u.headers)
          ) {
            ...
            (N.onreadystatechange = function () {
              if (N.readyState == 4) {
                ...
                if (
                  ...
                  if (
                    ((m = m || f(u.mimeType || N.getResponseHeader('content-type'))),
                    N.responseType == 'arraybuffer' || N.responseType == 'blob')
                  ) {
                    e = N.response
                  } else {
                    e = N.responseText
                    try {
                      ;(e = c(e, m, u)),
                        m == 'script'
                          ...
                          : m == 'xml'
                          ? (e = N.responseXML)
                          : m == 'json' && (e = S.test(e) ? null : t.parseJSON(e))
                    } catch (r) {
                      n = r
                    }
        ...
        (t.post = function () {
          const e = d.apply(null, arguments)
      ...
      t.param = function (e, n) {
        ...
        return (
          (r.add = function (e, n) {
            t.isFunction(n) && (n = n()), n == null && (n = ''), this.push(N(e) + '=' + N(n))
          }),
          m(r, e, n),
          r.join('&').replace(/%20/g, '+')
        )
          ...
          this[0] &&
            t.each(this[0].elements, function (r, o) {
              ;(n = o.type),
                (e = o.name),
                e &&
                  o.nodeName.toLowerCase() != 'fieldset' &&
                  !o.disabled &&
                  n != 'submit' &&
                  n != 'reset' &&
                  n != 'button' &&
                  n != 'file' &&
                  ((n != 'radio' && n != 'checkbox') || o.checked) &&
                  i(t(o).val())
            }),
          r
        )
...
layui.define(['layer-mobile', 'zepto'], function (e) {
  'use strict'
  const t = layui.zepto
  const a = layui['layer-mobile']
  const i = (layui.device(), 'layui-upload-enter')
  const n = 'layui-upload-iframe'
  const r = { icon: 2, shift: 6 }
  const o = { file: '文件', video: '视频', audio: '音频' }
  a.msg = function (e) {
  ...
  ;(s.prototype.init = function () {
    ...
    const a = e.options
    const r = t('body')
    const s = t(a.elem || '.layui-upload-file')
    const u = t('<iframe id="' + n + '" class="' + n + '" name="' + n + '"></iframe>')
    return (
      t('#' + n)[0] || r.append(u),
      s.each(function (r, s) {
        s = t(s)
        let u =
          ...
          (a.url || '') +
          '"></form>'
        const l = s.attr('lay-type') || a.type
        a.unwrap ||
          (u =
          ...
          s.parent('form').attr('target') === n &&
            (a.unwrap ? s.unwrap() : (s.parent().next().remove(), s.unwrap().unwrap())),
          s.wrap(u),
    ...
    (s.prototype.action = function (e, i) {
      ...
      if (u) {
        switch (i) {
          ...
          case 'video':
            if (
              !RegExp('\\w\\.(' + (p || 'avi|mp4|wma|rmvb|rm|flash|3gp|flv') + ')$', 'i').test(
                escape(u)
              )
            ) {
        ...
        var f = setInterval(function () {
          ...
          if (t) {
            ...
            typeof s.success === 'function' && s.success(t, e)
          }
        }, 30)
        e.value = ''
      }
