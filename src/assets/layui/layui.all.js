...
!(function () {
  'use strict'
  const e = window.layui && layui.define
  var t = {
    getPath: (function () {
    ...
    getStyle: function (e, t) {
      const n = e.currentStyle ? e.currentStyle : window.getComputedStyle(e, null)
          ...
          typeof a === 'function' &&
            !(function c() {
              return ++d > 80
                ...
                : void (parseInt(t.getStyle(document.getElementById(l), 'width')) === 1989
                    ? a()
                    : setTimeout(c, 100))
            })()
      }
  ...
  var n = {
    ...
    ready: function (a) {
      const i = 'laydate'
      const r = ''
      const o = (e ? 'modules/laydate/' : 'theme/') + 'default/laydate.css?v=' + n.v + r
  ...
  const i = 'laydate'
  const r = '.layui-laydate'
  const o = 'layui-this'
  const s = 'laydate-disabled'
  const l = '开始日期超出了结束日期<br>建议重新选择'
  const d = [100, 2e5]
  const c = 'layui-laydate-static'
  const m = 'layui-laydate-list'
  const u = 'laydate-selected'
  const h = 'layui-laydate-hint'
  const y = 'laydate-day-prev'
  const f = 'laydate-day-next'
  const p = 'layui-laydate-footer'
  const g = '.laydate-btns-confirm'
  const v = 'laydate-time-text'
  const D = '.laydate-btns-time'
  const T = function (e) {
    const t = this
    ;(t.index = ++n.index),
  ...
  var C = function (e) {
    for (
      let t = 0,
        n =
          typeof e === 'object' ? [e] : ((this.selector = e), document.querySelectorAll(e || null));
      t < n.length;
      t++
    ) {
      this.push(n[t])
  ...
  ;(C.prototype = []),
    ...
    (w.extend = function () {
      ...
      const n = function (e, t) {
        ...
        for (const a in t) e[a] = t[a] && t[a].constructor === Object ? n(e[a], t[a]) : t[a]
        return e
      }
    ...
    (C.prototype.find = function (e) {
      ...
      return (
        this.each(function (r, o) {
          for (let s = i ? [e] : o.querySelectorAll(e || null); n < s.length; n++) a.push(s[n])
          t.shift()
        }),
    ...
    (T.prototype.init = function () {
      const e = this
      const t = e.config
      const n = 'yyyy|y|MM|M|dd|d|HH|H|mm|m|ss|s'
      ...
      ;(t.elem = w(t.elem)),
        ...
        t.elem[0] &&
          ...
          w.each(e.format, function (t, a) {
            const i = new RegExp(n).test(a)
              ? '\\d{' +
                (function () {
                  return new RegExp(n).test(e.format[t === 0 ? t + 1 : t - 1] || '')
                    ? /^yyyy|y$/.test(a)
                      ? 4
                      : a.length
                    : /^yyyy$/.test(a)
          ...
          w.each(['min', 'max'], function (e, n) {
            ...
            if (typeof t[n] === 'number') {
              ...
              const s = 864e5
              const l = new Date(r ? (r < s ? o + r * s : r) : o)
    ...
    (T.prototype.render = function () {
      ...
      const n = e.lang()
      const a = t.position === 'static'
      const i = (e.elem = w.elem('div', {
        id: e.elemID,
        class: [
          'layui-laydate',
          t.range ? ' layui-laydate-range' : '',
          a ? ' ' + c : '',
          t.theme && t.theme !== 'default' && !/^#/.test(t.theme) ? ' laydate-theme-' + t.theme : ''
        ].join('')
      }))
      const r = (e.elemMain = [])
      const o = (e.elemHeader = [])
      const s = (e.elemCont = [])
      const l = (e.table = [])
      const d = (e.footer = w.elem('div', { class: p }))
      if (
        (t.zIndex && (i.style.zIndex = t.zIndex),
        w.each(new Array(2), function (e) {
          if (!t.range && e > 0) return !0
          const a = w.elem('div', { class: 'layui-laydate-header' })
          const i = [
            (function () {
              const e = w.elem('i', { class: 'layui-icon laydate-icon laydate-prev-y' })
              return (e.innerHTML = '&#xe65a;'), e
            })(),
            (function () {
              const e = w.elem('i', { class: 'layui-icon laydate-icon laydate-prev-m' })
              return (e.innerHTML = '&#xe603;'), e
            })(),
            (function () {
              const e = w.elem('div', { class: 'laydate-set-ym' })
              const t = w.elem('span')
              const n = w.elem('span')
              return e.appendChild(t), e.appendChild(n), e
            })(),
            (function () {
              const e = w.elem('i', { class: 'layui-icon laydate-icon laydate-next-m' })
              return (e.innerHTML = '&#xe602;'), e
            })(),
            (function () {
              const e = w.elem('i', { class: 'layui-icon laydate-icon laydate-next-y' })
              return (e.innerHTML = '&#xe65b;'), e
            })()
          ]
          const d = w.elem('div', { class: 'layui-laydate-content' })
          const c = w.elem('table')
          const m = w.elem('thead')
          const u = w.elem('tr')
        ...
        w(d).html(
          (function () {
            ...
            return (
              t.type === 'datetime' &&
                e.push(
                  '<span lay-type="datetime" class="laydate-btns-time">' + n.timeTips + '</span>'
                ),
              w.each(t.btns, function (e, r) {
                let o = n.tools[r] || 'btn'
                ;(t.range && r === 'now') ||
                  (a && r === 'clear' && (o = t.lang === 'cn' ? '重置' : 'Reset'),
                  i.push(
    ...
    (T.prototype.position = function () {
      const e = this
      const t = e.config
      const n = e.bindElem || t.elem[0]
      const a = n.getBoundingClientRect()
      const i = e.elem.offsetWidth
      const r = e.elem.offsetHeight
      const o = function (e) {
    ...
    (T.prototype.hint = function (e) {
      const t = this
      const n = (t.config, w.elem('div', { class: h }))
      ;(n.innerHTML = e || ''),
        w(t.elem)
          .find('.' + h)
          .remove(),
    ...
    (T.prototype.checkDate = function (e) {
      ...
      let a
      const i = this
      const r = (new Date(), i.config)
      const o = (r.dateTime = r.dateTime || i.systemDate())
      const s = i.bindElem || r.elem[0]
      let l =
        (i.isInput(s) ? 'val' : 'html',
        i.isInput(s) ? s.value : r.position === 'static' ? '' : s.innerHTML)
      const c = function (e) {
          ...
          w.each(i.format, function (s, l) {
            ...
            t[s].length < l.length && (a = !0),
              /yyyy|y/.test(l)
                ...
                : /ss|s/.test(l) &&
                  (c < 1 && ((c = 0), (a = !0)), (e.seconds = c), r.range && (i[o[n]].seconds = c))
          }),
          c(e)
      }
      return e === 'limit'
    ...
    (T.prototype.limit = function (e, t, n, a) {
      ...
      const o = r.config
      const l = {}
      const d = o[n > 41 ? 'endDate' : 'dateTime']
      const c = w.extend({}, d, t || {})
      return (
    ...
    (T.prototype.calendar = function (e) {
      ...
      const r = this
      const s = r.config
      const l = e || s.dateTime
      const c = new Date()
      const m = r.lang()
      const u = s.type !== 'date' && s.type !== 'datetime'
      const h = e ? 1 : 0
      const y = w(r.table[h]).find('td')
      const f = w(r.elemHeader[h][2]).find('span')
      if (
        ...
        const p = r.getAsYM(l.year, l.month)
    ...
    (T.prototype.list = function (e, t) {
      ...
      const i = a.dateTime
      const r = n.lang()
      const l = a.range && a.type !== 'date' && a.type !== 'datetime'
      const d = w.elem('ul', {
        class:
          m +
          ' ' +
          { year: 'laydate-year-list', month: 'laydate-month-list', time: 'laydate-time-list' }[e]
      })
      const c = n.elemHeader[t]
      const u = w(c[2]).find('span')
      const h = n.elemCont[t || 0]
      const y = w(h).find('.' + m)[0]
      const f = a.lang === 'cn'
      const p = f ? '年' : ''
      const T = n.listYM[t] || {}
      const C = ['hours', 'minutes', 'seconds']
      const x = ['startTime', 'endTime'][t]
      if ((T[0] < 1 && (T[0] = 1), e === 'year')) {
        let M
        let b = (M = T[0] - 7)
        b < 1 && (b = M = 1),
          w.each(new Array(15), function (e) {
            const i = w.elem('li', { 'lay-ym': M })
            const r = { year: M }
        ...
        w.each(new Array(12), function (e) {
          const i = w.elem('li', { 'lay-ym': e })
          const s = { year: T[0], month: e }
      ...
      if ((y && h.removeChild(y), h.appendChild(d), e === 'year' || e === 'month')) {
        w(n.elemMain[t]).addClass('laydate-ym-show'),
          w(d)
            .find('li')
            .on('click', function () {
              const r = 0 | w(this).attr('lay-ym')
              if (!w(this).hasClass(s)) {
                if (t === 0) {
                  ;(i[e] = r), l && (n.startDate[e] = r), n.limit(w(n.footer).find(g), null, 0)
                } else if (l) n.endDate[e] = r
                else {
                  const c = e === 'year' ? n.getAsYM(r, T[1] - 1, 'sub') : n.getAsYM(T[0], r, 'sub')
                  w.extend(i, { year: c[0], month: c[1] })
                }
                a.type === 'year' || a.type === 'month'
                  ? (w(d)
                      .find('.' + o)
                      .removeClass(o),
                    w(this).addClass(o),
    ...
    (T.prototype.setBtnStatus = function (e, t, n) {
      ...
      const i = this
      const r = i.config
      const o = w(i.footer).find(g)
      const d = r.range && r.type !== 'date' && r.type !== 'time'
      d &&
        ((t = t || i.startDate),
        (n = n || i.endDate),
    ...
    (T.prototype.setValue = function (e) {
      const t = this
      const n = t.config
      const a = t.bindElem || n.elem[0]
      const i = t.isInput(a) ? 'val' : 'html'
      return n.position === 'static' || w(a)[i](e || ''), this
    }),
    (T.prototype.stampRange = function () {
      ...
      const n = this
      const a = n.config
      const i = w(n.elem).find('td')
      if ((a.range && !n.endDate && w(n.footer).find(g).addClass(s), n.endDate)) {
        return (
          (e = n
            .newDate({ year: n.startDate.year, month: n.startDate.month, date: n.startDate.date })
            .getTime()),
          (t = n
            .newDate({ year: n.endDate.year, month: n.endDate.month, date: n.endDate.date })
            .getTime()),
          e > t
            ? n.hint(l)
            : void w.each(i, function (a, i) {
                const r = w(i).attr('lay-ymd').split('-')
                const s = n.newDate({ year: r[0], month: r[1] - 1, date: r[2] }).getTime()
                w(i).removeClass(u + ' ' + o),
                  (s !== e && s !== t) ||
    ...
    (T.prototype.done = function (e, t) {
      const n = this
      const a = n.config
      const i = w.extend({}, n.startDate ? w.extend(n.startDate, n.startTime) : a.dateTime)
      const r = w.extend({}, w.extend(n.endDate, n.endTime))
      return (
    ...
    (T.prototype.choose = function (e) {
      ...
      const n = t.config
      const a = n.dateTime
      const i = w(t.elem).find('td')
      let r = e.attr('lay-ymd').split('-')
      const l = function (e) {
        new Date()
        e && w.extend(a, r),
          n.range &&
            (t.startDate ? w.extend(t.startDate, r) : (t.startDate = w.extend({}, r, t.startTime)),
            (t.startYMD = r))
      }
      if (((r = { year: 0 | r[0], month: (0 | r[1]) - 1, date: 0 | r[2] }), !e.hasClass(s))) {
        if (n.range) {
          ...
          n.position === 'static'
            ...
            : n.type === 'datetime' && (l(!0), t.calendar().done(null, 'change'))
        }
      }
    }),
    ...
    (T.prototype.change = function (e) {
      ...
      const n = t.config
      const a = n.dateTime
      const i = n.range && (n.type === 'year' || n.type === 'month')
      const r = t.elemCont[e || 0]
      const o = t.listYM[e]
      const s = function (s) {
        const l = ['startDate', 'endDate'][e]
        const d = w(r).find('.laydate-year-list')[0]
        const c = w(r).find('.laydate-month-list')[0]
        return (
      ...
      return {
        ...
        prevMonth: function () {
          const e = t.getAsYM(a.year, a.month, 'sub')
          w.extend(a, { year: e[0], month: e[1] }),
            t.checkDate('limit').calendar(),
            n.range || t.done(null, 'change')
        },
        nextMonth: function () {
          const e = t.getAsYM(a.year, a.month)
          w.extend(a, { year: e[0], month: e[1] }),
            t.checkDate('limit').calendar(),
            n.range || t.done(null, 'change')
        },
...
!(function (e, t) {
  ...
  function s() {
    ;(re.addEventListener || e.event.type === 'load' || re.readyState === 'complete') &&
      (a(), pe.ready())
  }
  function u(e, t, n) {
    if (void 0 === n && e.nodeType === 1) {
      const r = 'data-' + t.replace(_e, '-$1').toLowerCase()
      if (((n = e.getAttribute(r)), typeof n === 'string')) {
        try {
          n =
            n === 'true' ||
            (n !== 'false' &&
              (n === 'null' ? null : +n + '' === n ? +n : qe.test(n) ? pe.parseJSON(n) : n))
        } catch (i) {}
        pe.data(e, t, n)
      } else n = void 0
    }
  ...
  function l(e) {
    let t
    for (t in e) if ((t !== 'data' || !pe.isEmptyObject(e[t])) && t !== 'toJSON') return !1
    return !0
  }
  function c(e, t, n, r) {
    if (He(e)) {
      ...
      const a = pe.expando
      const s = e.nodeType
      const u = s ? pe.cache : e
      let l = s ? e[a] : e[a] && a
      if ((l && u[l] && (r || u[l].data)) || void 0 !== n || typeof t !== 'string') {
        return (
          ...
          typeof t === 'string' ? ((i = o[t]), i == null && (i = o[pe.camelCase(t)])) : (i = o),
          i
        )
      }
    }
  ...
  function f(e, t, n) {
    if (He(e)) {
      ...
      let i
      const o = e.nodeType
      const a = o ? pe.cache : e
      const s = o ? e[pe.expando] : pe.expando
      if (a[s]) {
  ...
  function d(e, t, n, r) {
    ...
    const u = s()
    let l = (n && n[3]) || (pe.cssNumber[t] ? '' : 'px')
    let c = (pe.cssNumber[t] || (l !== 'px' && +u)) && Me.exec(pe.css(e, t))
    if (c && c[3] !== l) {
      ;(l = l || c[3]), (n = n || []), (c = +u || 1)
  ...
  function h(e, t) {
    ...
    let o =
      typeof e.getElementsByTagName !== 'undefined'
        ...
        : void 0
    if (!o) {
      for (o = [], n = e.childNodes || e; (r = n[i]) != null; i++) {
  ...
  function y(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f, d = e.length, y = p(t), v = [], x = 0; x < d; x++) {
      if (((a = e[x]), a || a === 0)) {
        if (pe.type(a) === 'object') pe.merge(v, a.nodeType ? [a] : a)
        else if (Ue.test(a)) {
          for (
          ...
          if (
            (!fe.leadingWhitespace && $e.test(a) && v.push(t.createTextNode($e.exec(a)[0])),
            !fe.tbody)
          ) {
            for (
              a =
    ...
    for (
      ...
      if (r && pe.inArray(a, r) > -1) i && i.push(a)
        ...
        ((s = pe.contains(a.ownerDocument, a)), (u = h(y.appendChild(a), 'script')), s && g(u), n)
      ) {
  ...
  function T(e, t) {
    return pe.nodeName(e, 'table') && pe.nodeName(t.nodeType !== 11 ? t : t.firstChild, 'tr')
  ...
  function S(e, t, n, r) {
    ...
    const d = f - 1
    const p = t[0]
    const g = pe.isFunction(p)
    if (g || (f > 1 && typeof p === 'string' && !fe.checkClone && rt.test(p))) {
  ...
  function A(e, t, n) {
    for (var r, i = t ? pe.filter(t, e) : e, o = 0; (r = i[o]) != null; o++) {
      n || r.nodeType !== 1 || pe.cleanData(h(r)),
        r.parentNode &&
          (n && pe.contains(r.ownerDocument, r) && g(h(r, 'script')), r.parentNode.removeChild(r))
    }
    return e
  }
  function D(e, t) {
    const n = pe(t.createElement(e)).appendTo(t.body)
    const r = pe.css(n[0], 'display')
    return n.detach(), r
  }
  function j(e) {
    let t = re
  ...
  function H(e) {
    if (e in Et) return e
    for (let t = e.charAt(0).toUpperCase() + e.slice(1), n = Ct.length; n--; ) {
  ...
  function F(e, t, n, r, i) {
    for (
      var o = n === (r ? 'border' : 'content') ? 4 : t === 'width' ? 1 : 0, a = 0;
      o < 4;
      o += 2
    ) {
      n === 'margin' && (a += pe.css(e, n + Oe[o], !0, i)),
        r
          ? (n === 'content' && (a -= pe.css(e, 'padding' + Oe[o], !0, i)),
            n !== 'margin' && (a -= pe.css(e, 'border' + Oe[o] + 'Width', !0, i)))
          : ((a += pe.css(e, 'padding' + Oe[o], !0, i)),
            n !== 'padding' && (a += pe.css(e, 'border' + Oe[o] + 'Width', !0, i)))
    }
    return a
  }
  function M(t, n, r) {
    let i = !0
    let o = n === 'width' ? t.offsetWidth : t.offsetHeight
    const a = ht(t)
    const s = fe.boxSizing && pe.css(t, 'boxSizing', !1, a) === 'border-box'
    if (
      ...
      if (((o = gt(t, n, a)), (o < 0 || o == null) && (o = t.style[n]), ft.test(o))) return o
  ...
  function B(e, t, n) {
    for (
      var r, i = ($.tweeners[t] || []).concat($.tweeners['*']), o = 0, a = i.length;
      o < a;
      o++
    ) {
  ...
  function W(e, t, n) {
    ...
    const d = {}
    const p = e.style
    let h = e.nodeType && Re(e)
    let g = pe._data(e, 'fxshow')
    n.queue ||
      ...
      e.nodeType === 1 &&
        ...
        (l = pe.css(e, 'display')),
        (c = l === 'none' ? pe._data(e, 'olddisplay') || j(e.nodeName) : l),
        c === 'inline' &&
          pe.css(e, 'float') === 'none' &&
          (fe.inlineBlockNeedsLayout && j(e.nodeName) !== 'inline'
            ? (p.zoom = 1)
    ...
    for (r in t) {
      if (((i = t[r]), St.exec(i))) {
        if ((delete t[r], (o = o || i === 'toggle'), i === (h ? 'hide' : 'show'))) {
    ...
    if (pe.isEmptyObject(d)) (l === 'none' ? j(e.nodeName) : l) === 'inline' && (p.display = l)
    else {
      ...
      for (r in d) {
        ;(a = B(h ? g[r] : 0, r, f)),
          r in g ||
            ((g[r] = a.start),
            h && ((a.end = a.start), (a.start = r === 'width' || r === 'height' ? 1 : 0)))
      }
    }
  }
  function I(e, t) {
  ...
  function $(e, t, n) {
    ...
    let i
    let o = 0
    const a = $.prefilters.length
    const s = pe.Deferred().always(function () {
      delete u.elem
    })
    var u = function () {
      if (i) return !1
    ...
    var l = s.promise({
      ...
      createTween: function (t, n) {
        const r = pe.Tween(e, l.opts, t, n, l.opts.specialEasing[t] || l.opts.easing)
  ...
  function V(e, t) {
    let n
    let r
    const i = pe.ajaxSettings.flatOptions || {}
  ...
  function Q(e, t, n, r) {
    ...
    if (pe.isArray(t)) {
      pe.each(t, function (t, i) {
        n || rn.test(e)
          ? r(e, i)
          : Q(e + '[' + (typeof i === 'object' && i != null ? t : '') + ']', i, n, r)
      })
    } else if (n || pe.type(t) !== 'object') r(e, t)
  ...
  function te(e) {
    return pe.isWindow(e) ? e : e.nodeType === 9 && (e.defaultView || e.parentWindow)
  }
  var ne = []
  var re = e.document
  const ie = ne.slice
  ...
  const ce = ue.hasOwnProperty
  var fe = {}
  const de = '1.12.3'
  var pe = function (e, t) {
    return new pe.fn.init(e, t)
  }
  const he = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g
  const ge = /^-ms-/
  const me = /-([\da-z])/gi
  ...
  ;(pe.fn = pe.prototype =
    {
      ...
      get: function (e) {
        return e != null ? (e < 0 ? this[e + this.length] : this[e]) : ie.call(this)
      },
    ...
    pe.extend({
      ...
      isPlainObject: function (e) {
        let t
        if (!e || pe.type(e) !== 'object' || e.nodeType || pe.isWindow(e)) return !1
        try {
          if (
            e.constructor &&
      ...
      makeArray: function (e, t) {
        ...
        return (
          e != null &&
            (n(Object(e)) ? pe.merge(r, typeof e === 'string' ? [e] : e) : ae.call(r, e)),
          r
        )
      },
      ...
      map: function (e, t, r) {
        ...
        let a = 0
        const s = []
        if (n(e)) for (i = e.length; a < i; a++) (o = t(e[a], a, r)), o != null && s.push(o)
      ...
      proxy: function (e, t) {
        let n, r, i
        if ((typeof t === 'string' && ((i = e[t]), (t = e), (e = i)), pe.isFunction(e))) {
          return (
    ...
    typeof Symbol === 'function' && (pe.fn[Symbol.iterator] = ne[Symbol.iterator]),
    pe.each(
  ...
  const ve = (function (e) {
    function t(e, t, n, r) {
      ...
      const g = t ? t.nodeType : 9
      if (((n = n || []), typeof e !== 'string' || !e || (g !== 1 && g !== 9 && g !== 11))) return n
    ...
    function a(e, t) {
      let n = t && e
      const r =
        n && e.nodeType === 1 && t.nodeType === 1 && (~t.sourceIndex || V) - (~e.sourceIndex || V)
      if (r) return r
    ...
    function p(e, t, n) {
      ...
      return t.first
        ...
        : function (t, n, a) {
            ...
            const c = [W, o]
            if (a) {
              for (; (t = t[r]); ) if ((t.nodeType === 1 || i) && e(t, n, a)) return !0
            } else {
              for (; (t = t[r]); ) {
                if (t.nodeType === 1 || i) {
                  if (
    ...
    function g(e, n, r) {
      for (let i = 0, o = n.length; i < o; i++) t(e, n[i], r)
      return r
    }
    ...
    function y(e, t, n, i, o, a) {
      return (
        ...
        r(function (r, a, s, u) {
          ...
          const p = []
          const h = a.length
          const y = r || g(t || '*', s.nodeType ? [s] : s, [])
          const v = !e || (!r && t) ? y : m(y, d, e, s, u)
          let x = n ? (o || (r ? e : h || i) ? [] : a) : v
          if ((n && n(v, x, s, u), i)) {
    ...
    function v(e) {
      for (
        var t,
          ...
          c = [
            function (e, n, r) {
              const i = (!o && (r || n !== A)) || ((t = n).nodeType ? u(e, n, r) : l(e, n, r))
              return (t = null), i
            }
          ];
        s < i;
        ...
        if ((n = T.relative[e[s].type])) c = [p(h(c), n)]
          ...
          if (((n = T.filter[e[s].type].apply(null, e[s].matches)), n[P])) {
            ...
            return y(
              s > 1 && h(c),
              s > 1 &&
                d(e.slice(0, s - 1).concat({ value: e[s - 2].type === ' ' ? '*' : '' })).replace(
                  se,
                  '$1'
                ),
              n,
    ...
    function x(e, n) {
      ...
      const a = function (r, a, s, u, l) {
        ...
        let y = []
        const v = A
        const x = r || (o && T.find.TAG('*', l))
        const b = (W += v == null ? 1 : Math.random() || 0.1)
        const w = x.length
        for (l && (A = a === H || a || l); h !== w && (c = x[h]) != null; h++) {
          if (o && c) {
    ...
    const ue = new RegExp('^' + ne + '*,' + ne + '*')
    const le = new RegExp('^' + ne + '*([>+~]|' + ne + ')' + ne + '*')
    const ce = new RegExp('=' + ne + '*([^\\]\'"]*?)' + ne + '*\\]', 'g')
    const fe = new RegExp(oe)
    var de = new RegExp('^' + re + '$')
    const pe = {
      ID: new RegExp('^#(' + re + ')'),
      CLASS: new RegExp('^\\.(' + re + ')'),
      TAG: new RegExp('^(' + re + '|[*])'),
    ...
    const he = /^(?:input|select|textarea|button)$/i
    const ge = /^h\d$/i
    const me = /^[^{]+\{\s*\[native \w/
    var ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/
    var ve = /[+~]/
    var xe = /'|\\/g
    const be = new RegExp('\\\\([\\da-f]{1,6}' + ne + '?|(' + ne + ')|.)', 'ig')
    ...
    ;(w = t.support = {}),
            ...
            ? ((H = r),
              ...
              w.getById
                ? ((T.find.ID = function (e, t) {
                    if (typeof t.getElementById !== 'undefined' && _) {
              ...
              (T.find.CLASS =
                ...
                function (e, t) {
                  if (typeof t.getElementsByClassName !== 'undefined' && _) {
      ...
      (t.matchesSelector = function (e, n) {
        if (
          ...
          try {
            const r = O.call(e, n)
            if (r || w.disconnectedMatch || (e.document && e.document.nodeType !== 11)) return r
          } catch (i) {}
        }
      ...
      (t.attr = function (e, t) {
        ;(e.ownerDocument || e) !== H && L(e)
        const n = T.attrHandle[t.toLowerCase()]
        let r = n && Y.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !_) : void 0
        return void 0 !== r
          ? r
          : w.attributes || !_
          ? e.getAttribute(t)
      ...
      (T = t.selectors =
        {
          ...
          filter: {
            TAG: function (e) {
              const t = e.replace(be, we).toLowerCase()
              return e === '*'
                ? function () {
                    return !0
                  }
                ...
                : function (t, n, u) {
                    ...
                    if (m) {
                      if (o) {
                        for (; g; ) {
                          for (d = t; (d = d[g]); ) {
                            if (s ? d.nodeName.toLowerCase() === y : d.nodeType === 1) return !1
                          }
                      ...
                      if (((h = [a ? m.firstChild : m.lastChild]), a && v)) {
                        ...
                        for (
                          ;
                          (d = (++p && d && d[g]) || (x = p = 0) || h.pop()) &&
                          ((s ? d.nodeName.toLowerCase() !== y : d.nodeType !== 1) ||
                            !++x ||
                            (v &&
                              ((f = d[P] || (d[P] = {})),
                              (c = f[d.uniqueID] || (f[d.uniqueID] = {})),
            ...
            PSEUDO: function (e, n) {
              let i
              const o =
                T.pseudos[e] || T.setFilters[e.toLowerCase()] || t.error('unsupported pseudo: ' + e)
              return o[P]
                ? o(n)
                : o.length > 1
                ? ((i = [e, e, '', n]),
  ...
  const we = pe.expr.match.needsContext
  const Te = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/
  var Ce = /^.[^:#\[\.,]*$/
  ;(pe.filter = function (e, t, n) {
    ...
    pe.fn.extend({
      ...
      is: function (e) {
        return !!r(this, typeof e === 'string' && we.test(e) ? pe(e) : e || [], !1).length
      }
    })
  let Ee
  const Ne = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/
  const ke = (pe.fn.init = function (e, t, n) {
    let r, i
    if (!e) return this
    if (((n = n || Ee), typeof e === 'string')) {
      if (
        ((r =
  ...
  const Se = /^(?:parents|prev(?:Until|All))/
  const Ae = { children: !0, contents: !0, next: !0, prev: !0 }
  pe.fn.extend({
    has: function (e) {
      let t
      const n = pe(e, this)
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = we.test(e) || typeof e !== 'string' ? pe(e, t || this.context) : 0;
        r < i;
        r++
      ) {
        for (n = this[r]; n && n !== t; n = n.parentNode) {
          if (
            n.nodeType < 11 &&
            (a ? a.index(n) > -1 : n.nodeType === 1 && pe.find.matchesSelector(n, e))
          ) {
            o.push(n)
            break
          }
    ...
    pe.each(
      ...
      function (e, t) {
        pe.fn[e] = function (n, r) {
          let i = pe.map(this, t, n)
          return (
            e.slice(-5) !== 'Until' && (r = n),
            r && typeof r === 'string' && (i = pe.filter(r, i)),
  ...
  ;(pe.Callbacks = function (e) {
    e = typeof e === 'string' ? o(e) : pe.extend({}, e)
    let t
    let n
    let r
    let i
            ...
            (function r(t) {
              pe.each(t, function (t, n) {
                pe.isFunction(n)
                  ...
                  : n && n.length && pe.type(n) !== 'string' && r(n)
              })
            })(arguments),
            n && !t && l()),
          this
    ...
    pe.extend({
      ...
      when: function (e) {
        ...
        let r
        let i = 0
        const o = ie.call(arguments)
        const a = o.length
        let s = a !== 1 || (e && pe.isFunction(e.promise)) ? a : 0
        const u = s === 1 ? e : pe.Deferred()
  ...
  ;(pe.fn.ready = function (e) {
    ...
    (pe.ready.promise = function (t) {
      if (!je) {
        if (
          ((je = pe.Deferred()),
          re.readyState === 'complete' ||
            (re.readyState !== 'loading' && !re.documentElement.doScroll))
        ) {
          ...
          let n = !1
          try {
            n = e.frameElement == null && re.documentElement
          } catch (r) {}
          n &&
            n.doScroll &&
            !(function i() {
  ...
  var He = function (e) {
    ...
    return (n === 1 || n === 9) && (!t || (t !== !0 && e.getAttribute('classid') === t))
  }
  var qe = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/
  var _e = /([A-Z])/g
  pe.extend({
    ...
    pe.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (this.length && ((i = pe.data(o)), o.nodeType === 1 && !pe._data(o, 'parsedAttrs'))) {
            for (n = a.length; n--; ) {
              a[n] &&
                ((r = a[n].name),
                r.indexOf('data-') === 0 && ((r = pe.camelCase(r.slice(5))), u(o, r, i[r])))
            }
      ...
      queue: function (e, t) {
        ...
        return (
          ...
          arguments.length < n
            ...
            ? this
            : this.each(function () {
                const n = pe.queue(this, e, t)
                pe._queueHooks(this, e), e === 'fx' && n[0] !== 'inprogress' && pe.dequeue(this, e)
              })
        )
      },
      dequeue: function (e) {
  ...
  const Fe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
  var Me = new RegExp('^(?:([+-])=|)(' + Fe + ')([a-z%]*)$', 'i')
  var Oe = ['Top', 'Right', 'Bottom', 'Left']
  var Re = function (e, t) {
    return (e = t || e), pe.css(e, 'display') === 'none' || !pe.contains(e.ownerDocument, e)
  }
  ...
  var We = /<([\w:-]+)/
  var Ie = /^$|\/(?:java|ecma)script/i
  var $e = /^\s+/
  var ze =
    'abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video'
  !(function () {
    const e = re.createElement('div')
    const t = re.createDocumentFragment()
    let n = re.createElement('input')
    ;(e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
      ...
      (fe.html5Clone = re.createElement('nav').cloneNode(!0).outerHTML !== '<:nav></:nav>'),
      (n.type = 'checkbox'),
      (n.checked = !0),
      t.appendChild(n),
  ...
  const Ye = /^(?:input|select|textarea)$/i
  const Je = /^key/
  const Ge = /^(?:mouse|pointer|contextmenu|drag|drop)|click/
  ...
  ;(pe.event = {
        ...
        for (
          n.handler && ((u = n), (n = u.handler), (i = u.selector)),
            ...
            (c = m.handle) ||
              ((c = m.handle =
                function (e) {
                  return typeof pe === 'undefined' || (e && pe.event.triggered === e.type)
                    ? void 0
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (m && (c = m.events)) {
        for (t = (t || '').match(De) || [''], l = t.length; l--; ) {
          if (
            ((s = Qe.exec(t[l]) || []), (p = g = s[1]), (h = (s[2] || '').split('.').sort()), p)
          ) {
            for (
    ...
    trigger: function (t, n, r, i) {
      ...
      let f
      const d = [r || re]
      let p = ce.call(t, 'type') ? t.type : t
      let h = ce.call(t, 'namespace') ? t.namespace.split('.') : []
      if (
        ((s = c = r = r || re),
        r.nodeType !== 3 &&
          r.nodeType !== 8 &&
          ...
          (a = p.indexOf(':') < 0 && 'on' + p),
          (t = t[pe.expando] ? t : new pe.Event(p, typeof t === 'object' && t)),
          (t.isTrigger = i ? 2 : 3),
          (t.namespace = h.join('.')),
    ...
    dispatch: function (e) {
      ...
      let o
      let a = []
      const s = ie.call(arguments)
      const u = (pe._data(this, 'events') || {})[e.type] || []
      const l = pe.event.special[e.type] || {}
      if (
        ((s[0] = e),
    ...
    fix: function (e) {
      ...
      const i = e.type
      const o = e
      let a = this.fixHooks[i]
      for (
        a ||
          (this.fixHooks[i] = a = Ge.test(i) ? this.mouseHooks : Je.test(i) ? this.keyHooks : {}),
    ...
    special: {
      ...
      click: {
        trigger: function () {
          if (pe.nodeName(this, 'input') && this.type === 'checkbox' && this.click) {
            return this.click(), !1
          }
        },
        _default: function (e) {
    ...
    simulate: function (e, t, n) {
      const r = pe.extend(new pe.Event(), n, { type: e, isSimulated: !0 })
        ...
        setup: function () {
          return (
            ...
            void pe.event.add(this, 'click._submit keypress._submit', function (e) {
              const t = e.target
              const n =
                pe.nodeName(t, 'input') || pe.nodeName(t, 'button') ? pe.prop(t, 'form') : void 0
              n &&
                !pe._data(n, 'submit') &&
      ...
      pe.each({ focus: 'focusin', blur: 'focusout' }, function (e, t) {
        ...
        pe.event.special[t] = {
          setup: function () {
            ...
            const i = pe._data(r, t)
            i || r.addEventListener(e, n, !0), pe._data(r, t, (i || 0) + 1)
          },
          teardown: function () {
            const r = this.ownerDocument || this
            const i = pe._data(r, t) - 1
  ...
  const Ze = / jQuery\d+="(?:null|\d+)"/g
  const et = new RegExp('<(?:' + ze + ')[\\s/>]', 'i')
  const tt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi
  const nt = /<script|<style|<link/i
  var rt = /checked\s*(?:[^=]|=\s*.checked.)/i
  var it = /^true\/(.*)/
  var ot = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
  const at = p(re)
  const st = at.appendChild(re.createElement('div'))
  pe.extend({
    ...
    clone: function (e, t, n) {
      ...
      let a
      let s
      const u = pe.contains(e.ownerDocument, e)
      if (
        ...
        for (r = h(o), s = h(e), a = 0; (i = s[a]) != null; ++a) r[a] && k(i, r[a])
      }
      if (t) {
        if (n) for (s = s || h(e), r = r || h(o), a = 0; (i = s[a]) != null; a++) N(i, r[a])
        else N(e, o)
      }
    ...
    cleanData: function (e, t) {
      for (
        ...
        if ((t || He(n)) && ((i = n[s]), (o = i && u[i]))) {
          ...
          u[i] &&
            (delete u[i],
            l || typeof n.removeAttribute === 'undefined' ? (n[s] = void 0) : n.removeAttribute(s),
            ne.push(i))
        }
      }
    }
      ...
      html: function (e) {
        return Pe(
          ...
          function (e) {
            ...
            let n = 0
            const r = this.length
            if (void 0 === e) return t.nodeType === 1 ? t.innerHTML.replace(Ze, '') : void 0
            if (
              typeof e === 'string' &&
              !nt.test(e) &&
              ...
              try {
                for (; n < r; n++) {
                  ;(t = this[n] || {}),
                    t.nodeType === 1 && (pe.cleanData(h(t, !1)), (t.innerHTML = e))
                }
                t = 0
              } catch (i) {}
            }
  ...
  let ut
  var lt = { HTML: 'block', BODY: 'block' }
  const ct = /^margin/
  var ft = new RegExp('^(' + Fe + ')(?!px)[a-z%]+$', 'i')
  ...
  const pt = re.documentElement
  !(function () {
    function t() {
      let t
      let c
      const f = re.documentElement
      f.appendChild(u),
        (l.style.cssText =
        ...
        e.getComputedStyle &&
          ...
          (n = (c || {}).top !== '1%'),
          (s = (c || {}).marginLeft === '2px'),
          (i = (c || { width: '4px' }).width === '4px'),
          (l.style.marginRight = '50%'),
          (r = (c || { marginRight: '4px' }).marginRight === '4px'),
    ...
    let a
    let s
    var u = re.createElement('div')
    var l = re.createElement('div')
    l.style &&
      ((l.style.cssText = 'float:left;opacity:.5'),
      (fe.opacity = l.style.opacity === '0.5'),
      (fe.cssFloat = !!l.style.cssFloat),
      (l.style.backgroundClip = 'content-box'),
      (l.cloneNode(!0).style.backgroundClip = ''),
      (fe.clearCloneStyle = l.style.backgroundClip === 'content-box'),
  ...
  let ht
  let gt
  const mt = /^(top|right|bottom|left)$/
  e.getComputedStyle
    ? ((ht = function (t) {
  ...
  const yt = /alpha\([^)]*\)/i
  const vt = /opacity\s*=\s*([^)]*)/i
  const xt = /^(none|table(?!-c[ea]).+)/
  var bt = new RegExp('^(' + Fe + ')(.*)$', 'i')
  const wt = { position: 'absolute', visibility: 'hidden', display: 'block' }
  const Tt = { letterSpacing: '0', fontWeight: '400' }
  var Ct = ['Webkit', 'O', 'Moz', 'ms']
  var Et = re.createElement('div').style
  pe.extend({
    cssHooks: {
      opacity: {
        get: function (e, t) {
          if (t) {
            const n = gt(e, 'opacity')
            return n === '' ? '1' : n
          }
        }
      }
    ...
    style: function (e, t, n, r) {
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        if (
          ((o = typeof n),
          o === 'string' && (i = Me.exec(n)) && i[1] && ((n = d(e, t, i)), (o = 'number')),
          n != null &&
            n === n &&
            (o === 'number' && (n += (i && i[3]) || (pe.cssNumber[s] ? '' : 'px')),
            fe.clearCloneStyle || n !== '' || t.indexOf('background') !== 0 || (u[t] = 'inherit'),
      ...
      pe.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          ...
          return _(
            e,
            n,
            r ? F(e, t, r, fe.boxSizing && pe.css(e, 'boxSizing', !1, i) === 'border-box', i) : 0
          )
        }
      }
    }),
    fe.opacity ||
      (pe.cssHooks.opacity = {
        ...
        set: function (e, t) {
          ...
          const i = pe.isNumeric(t) ? 'alpha(opacity=' + 100 * t + ')' : ''
    ...
    (O.prototype = {
      ...
      cur: function () {
        const e = O.propHooks[this.prop]
        return e && e.get ? e.get(this) : O.propHooks._default.get(this)
      },
      run: function (e) {
        let t
        const n = O.propHooks[this.prop]
        return (
          this.options.duration
            ? (this.pos = t =
                pe.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration))
            : (this.pos = t = e),
      ...
      _default: {
        get: function (e) {
          ...
          return e.elem.nodeType !== 1 || (e.elem[e.prop] != null && e.elem.style[e.prop] == null)
            ? e.elem[e.prop]
            : ((t = pe.css(e.elem, e.prop, '')), t && t !== 'auto' ? t : 0)
        },
        set: function (e) {
          pe.fx.step[e.prop]
            ? pe.fx.step[e.prop](e)
            : e.elem.nodeType !== 1 ||
              (e.elem.style[pe.cssProps[e.prop]] == null && !pe.cssHooks[e.prop])
            ? (e.elem[e.prop] = e.now)
  ...
  ;(pe.Animation = pe.extend($, {
    ...
    pe.fn.extend({
      ...
      animate: function (e, t, n, r) {
        const i = pe.isEmptyObject(e)
        const o = pe.speed(t, n, r)
        const a = function () {
          const t = $(this, pe.extend({}, e), o)
    ...
    (function () {
      let e
      let t = re.createElement('input')
      let n = re.createElement('div')
      const r = re.createElement('select')
      const i = r.appendChild(re.createElement('option'))
      ;(n = re.createElement('div')),
        ...
        (fe.getSetAttribute = n.className !== 't'),
        (fe.style = /top/.test(e.getAttribute('style'))),
        (fe.hrefNormalized = e.getAttribute('href') === '/a'),
        (fe.checkOn = !!t.value),
        ...
        if (i) {
          return (
            ...
            t && 'get' in t && void 0 !== (n = t.get(i, 'value'))
              ? n
              : ((n = i.value), typeof n === 'string' ? n.replace(Dt, '') : n == null ? '' : n)
          )
        }
      }
    }
          ...
          get: function (e) {
            for (
              ...
              if (
                ((n = r[u]),
                (n.selected || u === i) &&
                  (fe.optDisabled ? !n.disabled : n.getAttribute('disabled') === null) &&
  ...
  let Lt
  let Ht
  const qt = pe.expr.attrHandle
  const _t = /^(?:checked|selected)$/i
  const Ft = fe.getSetAttribute
  const Mt = fe.input
  pe.fn.extend({
    attr: function (e, t) {
          ...
          return typeof e.getAttribute === 'undefined'
            ...
            : ((o === 1 && pe.isXMLDoc(e)) ||
              ...
              void 0 !== n
                ...
                ? r
                : ((r = pe.find.attr(e, t)), r == null ? void 0 : r))
        }
      },
      attrHooks: {
        type: {
          set: function (e, t) {
            if (!fe.radioValue && t === 'radio' && pe.nodeName(e, 'input')) {
              const n = e.value
  ...
  const Ot = /^(?:input|select|textarea|button|object)$/i
  const Rt = /^(?:a|area)$/i
  pe.fn.extend({
    prop: function (e, t) {
    ...
    pe.extend({
      prop: function (e, t, n) {
        ...
        if (o !== 3 && o !== 8 && o !== 2) {
          return (
            (o === 1 && pe.isXMLDoc(e)) || ((t = pe.propFix[t] || t), (i = pe.propHooks[t])),
            void 0 !== n
              ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
  ...
  pe.fn.extend({
    addClass: function (e) {
      ...
      if (typeof e === 'string' && e) {
        for (t = e.match(De) || []; (n = this[u++]); ) {
          if (((i = z(n)), (r = n.nodeType === 1 && (' ' + i + ' ').replace(Pt, ' ')))) {
    ...
    hasClass: function (e) {
      ...
      let r = 0
      for (t = ' ' + e + ' '; (n = this[r++]); ) {
        if (n.nodeType === 1 && (' ' + z(n) + ' ').replace(Pt, ' ').indexOf(t) > -1) return !0
      }
      return !1
    }
  }),
    ...
    return i &&
      !pe.trim(
        i.replace($t, function (e, t, i, o) {
          return n && t && (r = 0), r === 0 ? e : ((n = i || t), (r += !o - !i), '')
        })
      )
      ? Function('return ' + i)()
  ...
  const Xt = /([?&])_=[^&]*/
  const Ut = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm
  const Vt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/
  const Yt = /^(?:GET|HEAD)$/
  const Jt = /^\/\//
  const Gt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/
  const Kt = {}
  ...
  const Zt = '*/'.concat('*')
  const en = Bt.href
  const tn = Gt.exec(en.toLowerCase()) || []
  pe.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ...
    ajax: function (t, n) {
      ...
      let c
      let f
      var d = pe.ajaxSetup({}, n)
      var p = d.context || d
      var h = d.context && (p.nodeType || p.jquery) ? pe(p) : pe.event
      var g = pe.Deferred()
      var m = pe.Callbacks('once memory')
      var y = d.statusCode || {}
      const v = {}
      const x = {}
      var b = 0
      ...
      if (d.beforeSend && (d.beforeSend.call(p, T, d) === !1 || b === 2)) return T.abort()
      w = 'abort'
      for (o in { success: 1, error: 1, complete: 1 }) T[o](d[o])
      if ((c = U(Qt, d, n, T))) {
        if (((T.readyState = 1), l && h.trigger('ajaxSend', [T, d]), b === 2)) return T
        d.async &&
          d.timeout > 0 &&
    ...
    pe.fn.extend({
      wrapAll: function (e) {
        ...
        if (this[0]) {
          const t = pe(e, this[0].ownerDocument).eq(0).clone(!0)
  ...
  var rn = /\[\]$/
  const on = /\r?\n/g
  const an = /^(?:submit|button|image|reset|file)$/i
  const sn = /^(?:input|select|textarea|keygen)/i
  ...
  let un = 0
  const ln = {}
  let cn = pe.ajaxSettings.xhr()
  e.attachEvent &&
    e.attachEvent('onunload', function () {
      for (const e in ln) ln[e](void 0, !0)
    }),
                ...
                (n = function (e, r) {
                  ...
                  if (n && (r || a.readyState === 4)) {
                    if ((delete ln[s], (n = void 0), (a.onreadystatechange = pe.noop), r)) {
                      ...
                      ;(l = {}),
                        (o = a.status),
                        typeof a.responseText === 'string' && (l.text = a.responseText)
                      try {
                        u = a.statusText
                      } catch (c) {
                        u = ''
    ...
    pe.ajaxTransport('script', function (e) {
      if (e.crossDomain) {
        let t
        const n = re.head || pe('head')[0] || re.documentElement
        return {
          send: function (r, i) {
  ...
  pe.ajaxSetup({
    ...
    jsonpCallback: function () {
      const e = fn.pop() || pe.expando + '_' + Wt++
      return (this[e] = !0), e
    }
  }),
    pe.ajaxPrefilter('json jsonp', function (t, n, r) {
      ...
      if (s || t.dataTypes[0] === 'jsonp') {
        return (
          (i = t.jsonpCallback =
            pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
          s
    ...
    (pe.parseHTML = function (e, t, n) {
      ...
      typeof t === 'boolean' && ((n = t), (t = !1)), (t = t || re)
      let r = Te.exec(e)
      const i = !n && []
      return r
        ? [t.createElement(r[1])]
  ...
  return (
    (pe.fn.load = function (e, t, n) {
      if (typeof e !== 'string' && pn) return pn.apply(this, arguments)
      let r
      let i
      let o
      const a = this
      ...
      return (
        ...
        pe.isFunction(t) ? ((n = t), (t = void 0)) : t && typeof t === 'object' && (i = 'POST'),
        a.length > 0 &&
          pe
    ...
    (pe.offset = {
      setOffset: function (e, t, n) {
        ...
        c === 'static' && (e.style.position = 'relative'),
          ...
          (o = pe.css(e, 'top')),
          (u = pe.css(e, 'left')),
          (l = (c === 'absolute' || c === 'fixed') && pe.inArray('auto', [o, u]) > -1),
          l
    ...
    pe.fn.extend({
      offset: function (e) {
        ...
        let r = { top: 0, left: 0 }
        const i = this[0]
        const o = i && i.ownerDocument
        if (o) {
          return (
            (t = o.documentElement),
            pe.contains(t, i)
              ? (typeof i.getBoundingClientRect !== 'undefined' && (r = i.getBoundingClientRect()),
                (n = te(o)),
                {
          ...
          function (e, r, i) {
            ...
            return void 0 === i
              ? o
                ...
                : e[r]
              : void (o
                  ? o.scrollTo(n ? pe(o).scrollLeft() : i, n ? i : pe(o).scrollTop())
                  : (e[r] = i))
          },
          e,
          r,
    ...
    pe.each({ Height: 'height', Width: 'width' }, function (e, t) {
      pe.each({ padding: 'inner' + e, content: t, '': 'outer' + e }, function (n, r) {
        pe.fn[r] = function (r, i) {
          ...
          const a = n || (r === !0 || i === !0 ? 'margin' : 'border')
          return Pe(
            this,
            function (t, n, r) {
              let i
...
!(function (e, t) {
          ...
          typeof i === 'function' &&
            !(function u() {
              return ++c > 80
                ...
                : void (parseInt(o.getStyle(document.getElementById(f), 'width')) === 1989
                    ? i()
                    : setTimeout(u, 100))
            })()
      }
  ...
  var r = {
    ...
    ready: function (e) {
      const t = 'layer'
      const i = ''
      const n = (a ? 'modules/layer/' : 'theme/') + 'default/layer.css?v=' + r.v + i
    ...
    msg: function (e, n, a) {
      ...
      const f = o.config.skin
      const c = (f ? f + ' ' + f + '-msg' : '') || 'layui-layer-msg'
      const u = l.anim.length - 1
      return (
        s && (a = n),
        r.open(
          i.extend(
  ...
  ;(l.anim = [
    ...
    (s.pt.vessel = function (e, t) {
      ...
      const r = n.config
      const s = r.zIndex + a
      const f = typeof r.title === 'object'
      const c = r.maxmin && (r.type === 1 || r.type === 2)
      const u = r.title
        ...
        t(
          [
            ...
            '<div class="' +
              ...
              ((r.type != 0 && r.type != 2) || r.shade ? '' : ' layui-layer-border') +
              ' ' +
              (r.skin || '') +
              '" id="' +
              l[0] +
              ...
              (r.btn
                ? (function () {
                    ...
                    for (let t = 0, i = r.btn.length; t < i; t++) {
    ...
    (s.pt.creat = function () {
      ...
      if (!t.id || !i('#' + t.id)[0]) {
        switch (
          (typeof t.area === 'string' && (t.area = t.area === 'auto' ? ['', ''] : [t.area, '']),
          ...
          case 4:
            f || (t.content = [t.content, 'body']),
              ...
              delete t.title,
              (t.tips = typeof t.tips === 'object' ? t.tips : [t.tips, !0]),
        ...
        if (
          ...
          const u = 'layer-anim ' + l.anim[t.anim]
          e.layero
            .addClass(u)
            .one(
    ...
    (s.pt.auto = function (e) {
      ...
      const s = [o.innerWidth(), o.innerHeight()]
      const f = o.find(l[1]).outerHeight() || 0
      const c = o.find('.' + l[6]).outerHeight() || 0
      const u = function (e) {
    ...
    (s.pt.offset = function () {
      ...
      const t = e.config
      const i = e.layero
      const a = [i.outerWidth(), i.outerHeight()]
      const o = typeof t.offset === 'object'
    ...
    (s.pt.tips = function () {
      ...
      const t = e.config
      const a = e.layero
      const o = [a.outerWidth(), a.outerHeight()]
      let r = i(t.follow)
      r[0] || (r = i('body'))
      const s = {
        width: r.outerWidth(),
      ...
      const f = a.find('.layui-layer-TipsG')
      const c = t.tips[0]
      t.tips[1] || f.remove(),
        (s.autoLeft = function () {
    ...
    (s.pt.move = function () {
      ...
      const a = i(document)
      const s = e.layero
      const l = s.find(t.move)
      const f = s.find('.layui-layer-resize')
      const c = {}
      return (
          ...
          .on('mousemove', function (i) {
            if (c.moveStart) {
              ...
              if (
                ...
                const f = n.width() - s.outerWidth() + c.stX
                const u = n.height() - s.outerHeight() + c.stY
                a < c.stX && (a = c.stX),
                  a > f && (a = f),
                  o < c.stY && (o = c.stY),
                  o > u && (o = u)
    ...
    (s.pt.callback = function () {
      function e() {
        const e = a.cancel && a.cancel(t.index, n)
        e === !1 || r.close(t.index)
      }
      var t = this
      var n = t.layero
        ...
        n
          ...
          .on('click', function () {
            ...
            if (e === 0) a.yes ? a.yes(t.index, n) : a.btn1 ? a.btn1(t.index, n) : r.close(t.index)
              ...
              const o = a['btn' + (e + 1)] && a['btn' + (e + 1)](t.index, n)
              o === !1 || r.close(t.index)
            }
          }),
    ...
    (o.reselect = function () {
      i.each(i('select'), function (e, t) {
        let n = i(this)
        n.parents('.' + l[0])[0] ||
          (n.attr('layer') == 1 && i('.' + l[0]).length < 1 && n.removeAttr('layer').show()),
          (n = null)
      })
    }),
    (s.pt.IE6 = function (e) {
      i('select').each(function (e, t) {
        let n = i(this)
        n.parents('.' + l[0])[0] || n.css('display') === 'none' || n.attr({ layer: '1' }).hide(),
          (n = null)
      })
    }),
    ...
    (r.iframeAuto = function (e) {
      if (e) {
        const t = r.getChildFrame('html', e).outerHeight()
        const n = i('#' + l[0] + e)
        const a = n.find(l[1]).outerHeight() || 0
        const o = n.find('.' + l[6]).outerHeight() || 0
    ...
    (r.style = function (e, t, n) {
      const a = i('#' + l[0] + e)
      const r = a.find('.layui-layer-content')
      const s = a.attr('type')
      const f = a.find(l[1]).outerHeight() || 0
      let c = a.find('.' + l[6]).outerHeight() || 0
      a.attr('minLeft')
      s !== o.type[3] &&
        s !== o.type[4] &&
        (n ||
    ...
    (r.min = function (e, t) {
      const a = i('#' + l[0] + e)
      const s = a.find(l[1]).outerHeight() || 0
      let f = a.attr('minLeft') || 181 * o.minIndex + 'px'
      const c = a.css('position')
      o.record(a),
        ...
        a.attr('type') === 'page' && a.find(l[4]).hide(),
        o.rescollbar(e),
    ...
    (r.restore = function (e) {
      ...
      r.style(
        ...
        t.attr('type') === 'page' && t.find(l[4]).show(),
        o.rescollbar(e)
    }),
    (r.full = function (e) {
      let t
    ...
    (r.title = function (e, t) {
      const n = i('#' + l[0] + (t || r.index)).find(l[1])
      n.html(e)
    }),
    (r.close = function (e) {
      const t = i('#' + l[0] + e)
      const n = t.attr('type')
      const a = 'layer-anim-close'
      if (t[0]) {
        const s = 'layui-layer-wrap'
        const f = function () {
          if (n === o.type[1] && t.attr('conType') === 'object') {
          ...
          typeof o.end[e] === 'function' && o.end[e](), delete o.end[e]
        }
  ...
  ;(r.prompt = function (e, t) {
        ...
        i.extend(
          {
            ...
            maxWidth: n.width(),
            success: function (e) {
              ;(s = e.find('.layui-layer-input')), s.focus(), typeof f === 'function' && f(e)
            },
            resize: !1,
            yes: function (i) {
              const n = s.val()
          ...
          i.extend(
            {
              ...
              content:
                ...
                '</ul>',
              success: function (t) {
                const o = t.find('.layui-layer-title').children()
                const r = t.find('.layui-layer-tabmain').children()
                o.on('mousedown', function (t) {
                  ...
                  a.addClass(n).siblings().removeClass(n),
                    ...
                    typeof e.change === 'function' && e.change(o)
                }),
    ...
    (r.photos = function (t, n, a) {
      ...
      const s = {}
      if (((t = t || {}), t.photos)) {
        const l = t.photos.constructor === Object
        const f = l ? t.photos : {}
        let u = f.data || []
        const d = f.start || 0
        ...
        ;(s.imgprev = function (e) {
          ...
          (s.keyup = function (e) {
            if (!s.end) {
              const t = e.keyCode
              e.preventDefault(),
                t === 37 ? s.imgprev(!0) : t === 39 ? s.imgnext(!0) : t === 27 && r.close(s.index)
            }
          }),
          (s.tabimg = function (e) {
            if (!(u.length <= 1)) {
                  ...
                  i.extend(
                    {
                      ...
                      area: (function () {
                        ...
                        const o = [i(e).width() - 100, i(e).height() - 100]
                        if (!t.full && (a[0] > o[0] || a[1] > o[1])) {
                          const r = [a[0] / o[0], a[1] / o[1]]
                          r[0] > r[1]
...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function (e) {
  'use strict'
  const t = layui.$
  const i = layui.laytpl
  const a = layui.laypage
  const l = layui.layer
  const n = layui.form
  const o = layui.hint()
  const r = layui.device()
  const d = {
  ...
  const h = 'layui-hide'
  const f = 'layui-none'
  const y = 'layui-table-view'
  const p = '.layui-table-header'
  const m = '.layui-table-body'
  const v = '.layui-table-main'
  const g = '.layui-table-fixed'
  const x = '.layui-table-fixed-l'
  const b = '.layui-table-fixed-r'
  const k = '.layui-table-tool'
  const C = '.layui-table-page'
  const w = '.layui-table-sort'
  const N = 'layui-table-edit'
  const F = 'layui-table-hover'
  const W = function (e) {
    const t =
  ...
  ;(A.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60 }),
    (A.prototype.render = function () {
      ...
      const l = a.elem
      const n = l.next('.' + y)
      const o = (e.elem = t(i(T).render({ VIEW_CLASS: y, data: a, index: e.index })))
      if (
        ((a.index = e.index),
        n[0] && n.remove(),
        l.after(o),
        ...
        const r = e.layFixed.find(p).find('th')
        r.height(
          e.layHeader.height() -
            1 -
            parseFloat(r.css('padding-top')) -
    ...
    (A.prototype.initOpts = function (e) {
      const t = this
      const i = (t.config, { checkbox: 48, space: 15, numbers: 40 })
      e.checkbox && (e.type = 'checkbox'),
        e.space && (e.type = 'space'),
        e.type || (e.type = 'normal'),
        e.type !== 'normal' && ((e.unresize = !0), (e.width = e.width || i[e.type]))
    }),
    (A.prototype.setArea = function () {
      ...
      e.eachCols(function () {
        ...
        (o -= (function () {
          return t.skin === 'line' || t.skin === 'nob' ? 2 : i + 1
        })()),
            ...
            return l
              ? (e.initOpts(l),
                ...
                void (
                  l.colspan > 1 ||
                  (/\d+%$/.test(r)
                    ? (l.width = r = Math.floor((parseFloat(r) / 100) * o))
                    : r || ((l.width = r = 0), a++),
                  (n += r))
                ))
              : void i.splice(t, 1)
        ...
        layui.each(t.cols, function (e, i) {
          layui.each(i, function (e, i) {
            const a = i.minWidth || t.cellMinWidth
            i.colspan > 1 || (i.width === 0 && (i.width = Math.floor(l >= a ? l : a)))
          })
        }),
        t.height &&
          /^full-\d+$/.test(t.height) &&
          ((e.fullHeightGap = t.height.split('-')[1]), (t.height = M.height() - e.fullHeightGap))
    }),
    ...
    (A.prototype.pullData = function (e, i) {
      ...
      const r = n.response
      const d = function () {
        typeof n.initSort === 'object' && a.sort(n.initSort.field, n.initSort.type)
      }
          ...
          t.ajax({
            ...
            success: function (t) {
              return t[r.statusName] != r.statusCode
                ? (a.renderForm(),
                  a.layMain.html(
                    '<div class="' + f + '">' + (t[r.msgName] || '返回的数据状态异常') + '</div>'
                  ))
                : (a.renderData(t, e, t[r.countName]),
                  d(),
                  (n.time = new Date().getTime() - a.startTime + ' ms'),
                  i && l.close(i),
                  void (typeof n.done === 'function' && n.done(t, e, t[r.countName])))
            },
            error: function (e, t) {
          ...
          : (layui.each(u, function (e, a) {
              ...
              a.length !== 0 &&
                ...
                c.eachCols(function (e, n) {
                  ...
                  if (((void 0 !== h && h !== null) || (h = ''), !(n.colspan > 1))) {
                    const y = [
                      '<td data-field="' +
                        r +
                        '" ' +
                      ...
                      '<div class="layui-table-cell laytable-cell-' +
                        (function () {
                          const e = s.index + '-' + r
                          return n.type === 'normal' ? e : e + ' laytable-cell-' + n.type
                        })() +
                        '">' +
                        (function () {
                          const e = t.extend(!0, { LAY_INDEX: f }, a)
                          return n.type === 'checkbox'
                            ? '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" ' +
                                (function () {
                                  const t = d.config.checkName
                                  return n[t]
                                    ? ((a[t] = n[t]), n[t] ? 'checked' : '')
                                    : e[t]
                                    ? 'checked'
                            ...
                            ? f
                            : n.toolbar
                            ? i(t(n.toolbar).html() || '').render(e)
                            : n.templet
                            ? i(t(n.templet).html() || String(h)).render(e)
                            : h
                        })(),
                      '</div></td>'
                    ].join('')
                    l.push(y),
                      n.fixed && n.fixed !== 'right' && o.push(y),
                      n.fixed === 'right' && u.push(y)
                  }
                }),
                h.push('<tr data-index="' + e + '">' + l.join('') + '</tr>'),
                y.push('<tr data-index="' + e + '">' + o.join('') + '</tr>'),
                p.push('<tr data-index="' + e + '">' + u.join('') + '</tr>'))
            }),
      ...
      return (
        ...
        r
          ...
          ? (c.renderForm(),
            ...
            c.layMain.find('.' + f).remove(),
            c.layMain.append('<div class="' + f + '">无数据</div>'))
          : (m(),
            void (
              s.page &&
              ((s.page = t.extend(
    ...
    (A.prototype.sort = function (e, i, a, l) {
      ...
      const u = {}
      const h = c.config
      const f = h.elem.attr('lay-filter')
      const y = d.cache[c.key]
      typeof e === 'string' &&
        c.layHeader.find('th').each(function (i, a) {
          const l = t(this)
          const o = l.data('field')
          if (o === e) return (e = l), (n = o), !1
        })
      try {
        var n = n || e.data('field')
        if (c.sortKey && !a && n === c.sortKey.field && i === c.sortKey.sort) return
        const p = c.layHeader.find('th .laytable-cell-' + h.index + '-' + n).find(w)
      ...
      ;(c.sortKey = { field: n, sort: i }),
        i === 'asc'
          ...
          : i === 'desc'
          ? (r = layui.sort(y, n, !0))
          : ((r = layui.sort(y, d.config.indexName)), delete c.sortKey),
        (u[h.response.dataName] = r),
        c.renderData(u, c.page, c.count, !0),
        l && layui.event.call(e, s, 'sort(' + f + ')', { field: n, type: i })
    }),
    (A.prototype.loading = function () {
      ...
      if (t.loading && t.url) {
        return l.msg('数据请求中', {
          icon: 16,
          offset: [
            e.elem.offset().top + e.elem.height() / 2 - 35 - M.scrollTop() + 'px',
            e.elem.offset().left + e.elem.width() / 2 - 90 - M.scrollLeft() + 'px'
          ],
          anim: -1,
          fixed: !1
        })
    ...
    (A.prototype.setCheckData = function (e, t) {
      const i = this
      const a = i.config
      const l = d.cache[i.key]
      l[e] && l[e].constructor !== Array && (l[e][a.checkName] = t)
    }),
    (A.prototype.syncCheckAll = function () {
      const e = this
      const t = e.config
      const i = e.layHeader.find('input[name="layTableCheckbox"]')
      const a = function (i) {
        return (
          e.eachCols(function (e, a) {
            a.type === 'checkbox' && (a[t.checkName] = i)
          }),
          i
        )
      }
    ...
    (A.prototype.getCssRule = function (e, t) {
      const i = this
      const a = i.elem.find('style')[0]
      const l = a.sheet || a.styleSheet || {}
      const n = l.cssRules || l.rules
    ...
    (A.prototype.fullSize = function () {
      ...
      let a = i.height
      t.fullHeightGap &&
        ((a = M.height() - t.fullHeightGap), a < 135 && (a = 135), t.elem.css('height', a)),
    ...
    (A.prototype.scrollPatch = function () {
      const e = this
      const i = e.layMain.children('table')
      const a = e.layMain.width() - e.layMain.prop('clientWidth')
      const l = e.layMain.height() - e.layMain.prop('clientHeight')
      const n = e.getScrollWidth(e.layMain[0])
      const o = i.outerWidth() - e.layMain.width()
      if (e.autoColNums && o < 5 && !e.scrollPatchWStatus) {
        const r = e.layHeader.eq(0).find('thead th:last-child')
        const d = r.data('field')
        e.getCssRule(d, function (t) {
          const i = t.style.width || r.outerWidth()
    ...
    (A.prototype.events = function () {
      ...
      const o = t('body')
      let c = {}
      const u = a.layHeader.find('th')
      const h = '.layui-table-cell'
      const f = n.elem.attr('lay-filter')
      u
        .on('mousemove', function (e) {
          const i = t(this)
          const a = i.offset().left
          const l = e.clientX - a
          i.attr('colspan') > 1 ||
            i.data('unresize') ||
            c.resizeStart ||
          ...
          if (c.allowResize) {
            ...
            e.preventDefault(),
              ...
              a.getCssRule(l, function (e) {
                const t = e.style.width || i.outerWidth()
                ;(c.rule = e),
        ...
        S.on('mousemove', function (t) {
          if (c.resizeStart) {
            if ((t.preventDefault(), c.rule)) {
              let i = c.ruleWidth + t.clientX - c.offset[0]
          ...
          c.resizeStart && ((c = {}), o.css('cursor', ''), a.scrollPatch()), e === 2 && (e = null)
        }),
        u
          .on('click', function () {
            let i
            const l = t(this)
            const n = l.find(w)
            const o = n.attr('lay-sort')
            return n[0] && e !== 1
              ? ((i = o === 'asc' ? 'desc' : o === 'desc' ? null : 'asc'),
          ...
          .on('click', function (e) {
            const i = t(this)
            const l = i.index()
            const n = i.parents('th').eq(0).data('field')
            layui.stope(e), l === 0 ? a.sort(n, 'asc', null, !0) : a.sort(n, 'desc', null, !0)
          }),
        a.elem.on('click', 'input[name="layTableCheckbox"]+', function () {
          const e = t(this).prev()
          const i = a.layBody.find('input[name="layTableCheckbox"]')
          const l = e.parents('tr').eq(0).data('index')
          const n = e[0].checked
          const o = e.attr('lay-filter') === 'layTableAllChoose'
          o
            ? (i.each(function (e, t) {
        ...
        a.layBody
          .on('change', '.' + N, function () {
            const e = t(this)
            const i = this.value
            const l = e.parent().data('field')
            const n = e.parents('tr').eq(0).data('index')
            const o = d.cache[a.key][n]
            ;(o[l] = i),
              layui.event.call(this, s, 'edit(' + f + ')', { value: i, data: o, field: l })
          })
          .on('blur', '.' + N, function () {
            let e
            const l = t(this)
            const n = l.parent().data('field')
            const o = l.parents('tr').eq(0).data('index')
            const r = d.cache[a.key][o]
        ...
        a.layBody.on('click', 'td', function () {
          const e = t(this)
          const i = (e.data('field'), e.data('edit'))
          const o = e.children(h)
          if ((l.close(a.tipsIndex), !e.data('off'))) {
            if (i) {
              if (i === 'select');
              else {
                const d = t('<input class="layui-input ' + N + '">')
              ...
              o.find('.layui-form-switch,.layui-form-checkbox')[0] ||
                (Math.round(o.prop('scrollWidth')) > Math.round(o.outerWidth()) &&
                  (a.tipsIndex = l.tips(
                    [
        ...
        a.layBody.on('click', '*[lay-event]', function () {
          const e = t(this)
          const l = e.parents('tr').eq(0).data('index')
          const n = a.layBody.find('tr[data-index="' + l + '"]')
          const o = 'layui-table-click'
          const r = d.cache[a.key][l]
            ...
            update: function (e) {
              ;(e = e || {}),
                layui.each(e, function (e, l) {
                  if (e in r) {
                    let o
                    const d = n.children('td[data-field="' + e + '"]')
                    ;(r[e] = l),
                      a.eachCols(function (t, i) {
    ...
    (d.init = function (e, i) {
      i = i || {}
      const a = this
      const l = t(e ? 'table[lay-filter="' + e + '"]' : u + '[lay-data]')
      const n = 'Table element property lay-data configuration item has a syntax error: '
      return (
        l.each(function () {
          const a = t(this)
          let l = a.attr('lay-data')
          try {
          ...
          const s = t.extend(
            {
              ...
              even: typeof a.attr('lay-even') === 'string'
            },
            d.config,
            i,
            l
          ...
          e && a.hide(),
            ...
            a.find('tbody>tr').each(function (e) {
              ...
              i.children('td').each(function (e, i) {
                const l = t(this)
                const n = l.data('field')
                if (n) return (a[n] = l.html())
              }),
                layui.each(c, function (e, t) {
                  const l = i.children('td').eq(e)
                  a[t.field] = l.html()
                }),
                (s.data[e] = a)
            }),
...
layui.define(['layer', 'form'], function (t) {
  ...
  const i = layui.layer
  const a = layui.form
  const l = (layui.hint(), layui.device())
  const n = 'layedit'
  const o = 'layui-show'
  const r = 'layui-disabled'
  const c = function () {
  ...
  ;(c.prototype.set = function (t) {
    ...
    (c.prototype.build = function (t, i) {
      ...
      const a = this
      const n = a.config
      const r = 'layui-layedit'
      const c = e('#' + t)
      const u = 'LAY_layedit_' + ++a.index
      const d = c.next('.' + r)
      const y = e.extend({}, n, i)
      const f = (function () {
        const t = []
        const e = {}
        return (
  ...
  var u = function (t) {
    const i = e('#LAY_layedit_' + t)
    const a = i.prop('contentWindow')
    return [a, i]
  }
  var d = function (t) {
    return (
  ...
  const v = function (t, i, a) {
    const l = this.document
    const n = document.createElement(t)
    for (const o in i) n.setAttribute(o, i[o])
    ...
    i && i[i.hasClass(l) ? 'removeClass' : 'addClass'](l),
      ...
      e(n)
        ...
        .each(function () {
          ...
          const e = this.style.textAlign
          ;(t !== 'b' && t !== 'strong') || o('b').addClass(l),
            (t !== 'i' && t !== 'em') || o('i').addClass(l),
            t === 'u' && o('u').addClass(l),
            t === 'strike' && o('d').addClass(l),
            t === 'p' &&
              (e === 'center'
                ? o('center').addClass(l)
                : e === 'right'
                ? o('right').addClass(l)
                : o('left').addClass(l)),
            t === 'a' && (o('link').addClass(l), o('unlink').removeClass(r))
        })
  }
  var g = function (t, a, l) {
    const n = t.document
    const o = e(n.body)
    const c = {
      link: function (i) {
        ...
        layui.use('upload', function (o) {
          ...
          o.render({
            ...
            elem: e(n).find('input')[0],
              ...
              e.code == 0
                ? ((e.data = e.data || {}),
                  v.call(t, 'img', { src: e.data.src, alt: e.data.title }, a))
                : i.msg(e.msg || '上传失败')
            }
          })
        })
    ...
    const s = a.find('.layui-layedit-tool')
    const u = function () {
      const i = e(this)
      const a = i.attr('layedit-event')
      const l = i.attr('lay-command')
      if (!i.hasClass(r)) {
        o.focus()
        const u = m(n)
    ...
    const n = i.open({
      ...
      content: [
        ...
        '<input type="radio" name="target" value="_self" class="layui-input" title="当前窗口"' +
          (t.target !== '_self' && t.target ? '' : 'checked') +
          '>',
        '<input type="radio" name="target" value="_blank" class="layui-input" title="新窗口" ' +
          (t.target === '_blank' ? 'checked' : '') +
          '>',
        '</div>',
        '</li>',
      ...
      success: function (t, n) {
        const o = 'submit(layedit-link-yes)'
        a.render('radio'),
  ...
  var x = function (t) {
    ...
    return (
      (x.hide =
        x.hide ||
        function (t) {
          e(t.target).attr('layedit-event') !== 'face' && i.close(x.index)
        }),
      (x.index = i.tips(
        (function () {
          const t = []
  ...
  var k = function (t) {
    ...
    const l = i.open({
      ...
      success: function (l, n) {
        const o = 'submit(layedit-code-yes)'
        a.render('select'),
...
layui
  .define('jquery', function (e) {
    'use strict'
    const a = layui.$
    const l = 'http://www.layui.com/doc/modules/code.html'
    e('code', function (e) {
      const t = []
      ;(e = e || {}),
